...
window.wdShowRecs=function(recs){
  try{
    if(!document.getElementById('wdRecCss')){
      ...
      +'.wrc{margin:14px 12px;padding:20px 18px;border-radius:14px;background:rgba(150,142,125,.42);box-shadow:0 2px 10px rgba(0,0,0,.25);}'
      +'.wrk{color:#fff;font-size:15px;font-weight:500;margin-bottom:14px;}'
      +'.wra{color:#fff;font-size:24px;font-weight:600;letter-spacing:.3px;margin-bottom:12px;}'
      +'.wrl{display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;}'
      +'.wrn{color:#aeb6cf;font-size:14px;}'
      +'.wrd{color:#aeb6cf;font-size:14px;direction:ltr;}'
      +'.wrf{color:#aeb6cf;font-size:14px;}'
      +'.wrf span{color:#8f97b2;}'
      +'.wrempty{color:#aeb6cf;text-align:center;padding:60px 20px;font-size:15px;}';
