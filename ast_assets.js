...
+'<div class="dsub">اختيار الشبكة</div>'
+'<div class="dnet"><span>USDT-TRC20</span><svg viewBox="0 0 24 24"><path d="M6 9l6 6 6-6"/></svg></div>'
+'<div class="dcpr"><span class="t">عنوان الإرسال</span><span class="dcp" onclick="cpT(\'TZ76Nx4tri1Seth6TuVGknLQDU49dKYxg\')"><svg viewBox="0 0 24 24"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M5 15H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v1"/></svg>نسخ</span></div>'
+'<div class="daddr" id="wdaddr">TZ76Nx4tri1Seth6TuVGknLQDU49dKYxg</div>'
+'<div class="dcpr"><span class="t">الكمية المستخرجة</span><span class="t">الرصيد المتوفر للسحب (USDT): <b id="wdbal">0.00</b></span></div>'
+'<div class="dnet"><input id="wdamt" type="number" min="0" step="any" placeholder="أدخل الكمية" style="flex:1;background:transparent;border:none;outline:none;color:inherit;font:inherit;padding:0;min-width:0;"><span class="dcp" onclick="wdFillMax()">السحب الكامل</span></div>'
+'<div class="dcpr"><span class="t">كلمة مرور التعامل</span></div>'
+'<div class="dnet"><input id="wdpass" type="password" placeholder="يرجى إدخال كلمة مرور التعامل" style="flex:1;width:100%;background:transparent;border:none;outline:none;color:inherit;font:inherit;padding:0;min-width:0;"></div>'
+'<button onclick="wdConfirm()" class="dnet" style="width:calc(100% - 28px);margin:18px 14px 0;justify-content:center;font-weight:700;cursor:pointer;">تأكيد السحب</button>'
+'<div class="wnote"><b>ملاحظة أمنية</b><p>Please check and make sure the address and grid are correct to avoid loss of funds. If you transfer to the wrong address, the lost funds will not be recovered.</p></div>'
+'</div>';
